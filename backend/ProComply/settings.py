"""
Django settings for ProComply project.
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'pro-comply-backend.onrender.com',
 ]
...
WSGI_APPLICATION = 'ProComply.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    'accounts.authentication.FirebaseBackend',
